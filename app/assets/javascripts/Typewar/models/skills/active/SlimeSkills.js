...
Typewar.Data.Skills["SlimeStandard"] = Typewar.Models.Skills.BaseNPCSkill.extend({
  defaults: {
    name: 'standard',
    properties: {
    ...
    positionFunc: function (req, opt){
      ...
      // TODO: this thing needs to be refactored somehow.  How to do it will 
      // be revealed after building a few more of these I think.
...
Typewar.Data.Skills["SlimeGlob"] = Typewar.Models.Skills.BaseNPCSkill.extend({
  defaults: {
    name: 'glob',
    properties: {
      blunt:    3, slashing: 0, piercing: 0, fire:     0,
