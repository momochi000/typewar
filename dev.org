...
*** Change how text library builds text fragments
    ...
    minimum
* Backlog
** TODO Create and handle lose condition
   Just needs to be stubbed for now
** TODO Create and handle win condition
   Same
** TODO rename Effects.SpawnTextFragLinear to something more generic.
