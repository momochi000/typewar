...
**** TODO create text fragment attack component
     Text fragment attack has some behavior:
***** display
...
**** TODO Build a third input system to handle commands
* Backlog
...
** TODO Skill properties should move to the appropriate effect :refactor:
   i.e. a skill has properties, but this should move to be an argument to the damage effect
** TODO Move player skill definition/initialization to the skill system :refactor:
