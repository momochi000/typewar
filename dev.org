...
*** TODO Typos with defended text will still have you take damage
...
** TODO Training dummy scene                                           :epic:
...
*** TODO scene data should be stored in a simple json such that it may be loaded from there
...
*** TODO Create tutorial program/wizard
**** TODO Has a set of tooltips the player can walk/move through
**** TODO They appear at arbitrary points of the screen
     They contain some text which flows out a character at a time rather than
     scrolling down from top to bottom
**** TODO Tutorial streams pause the game
**** TODO Tutorial panes can be controlled by keyboard
**** TODO Create tutorial run for training dummy scene 1
**** TODO Create tutorial run for training dummy scene 2
...
** TODO pull views out into their own files and abstract as necessary :refactor:
   Not sure this is necessary or even good..
* Roadmap
