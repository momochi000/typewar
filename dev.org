...
***** Do a little design work to determine how it should look roughly
***** Build a component to represent UI callout
...
***** Build a backbone view that attaches to the component
***** Add a handlebar template for the UI callout
***** Create an entity, render the view into the entity
***** Determine how to point the callout at various elements (other components or what?)
***** Encapsulate the data needed to generate the whole callout 
